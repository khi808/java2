...
public class StringCharAtExample {
	public static void main(String[] args) {
		...
		//문자열 자르기
		ssn = "880815-1234567";
		//index의 범위  0<= 범위 <6 // 0은포함 6은포함하지않음.
		...
		//"java Programming" 하나 만들어져 있기 때문에
		//새로 만들지 않고 위의 값을 참조함.
		...
		String val1 = String.valueOf(10);//int형 10 -> 숫자형 문자열 "10"
